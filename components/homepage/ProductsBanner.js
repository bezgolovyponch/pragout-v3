...
function ProductsBanner({ products, t }) {
  const fileteredProducts = products.filter((product) => product.categories.find((productCategory) => productCategory.slug === 'hottest'));
  const hottestProducts = fileteredProducts.slice(0, 5);
