  ...
  const animate = () => {
    ...
    if (x.matches) {
      if (dimensions.top - window.innerHeight < 0 && dimensions.bottom > 0) {
        ...
        const percentage = (window.innerHeight - dimensions.top) / window.innerHeight;
       // @ts-ignore
        image.current.style.transform = `translate3d(0, ${scrolledRatio * 50}vw, 0) scale3d(1.02439, 1.02439, 1)`;
         // @ts-ignore
        imageLow.current.style.transform = `translate3d(0, ${scrolledRatio * 50}vw, 0) scale3d(${percentage * 1.2},${
          percentage * 1.2
        }, 1)`;
        /*        if (percentage2 > 1) {
          image2.current.style.transform = `translate3d(0, ${
            -scrolledRatio * 1.5
          }vw, 0) scale3d( ${percentage2}, ${percentage2}, 1)`;
          image3.current.style.transform = `translate3d(0, ${
            -scrolledRatio * 1.3
          }vw, 0) scale3d(${percentage2},${percentage2}, 1)`;
        }*/
      }
          ...
          <div className="main-stag-package-div">
            <div className="main-stag-package-text">
              ...
              <p className="main-package-low-text">
                {t(
                  'Cool and complete - we created a pre-made bundle of top-rated activities in Prague for you to enjoy. Let true professionals who know what to do take care of the rest. Book your tour with a few clicks.',
                )}
              </p>
            </div>
